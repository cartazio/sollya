...
5.0482699999999999999999999999999999998619348971117e-2s were spent computing p =
...
8.7100284000000000000000000000000000000030405618997e-2 s were spent
\end{Verbatim}
\end{minipage}\end{center}
\noindent Example 3: 
\begin{center}\begin{minipage}{15cm}\begin{Verbatim}[frame=single]
...
1.38825299999999999999999999999999909822413325549782e-3s of execution overhead.
\end{Verbatim}
\end{minipage}\end{center}
\noindent Example 4: 
\begin{center}\begin{minipage}{15cm}\begin{Verbatim}[frame=single]
...
achine.\n");
This ratio = 2.8139065838597532796237410056869563892716904896061 should somehow 
