...
&nbsp;&nbsp;&nbsp;&gt; bashevaluate("tail -n -29 implementation.c");<br> 
...
<span class="category">See also: </span><?php linkTo("command","honorcoeffprec","honorcoeffprec");?>, <?php linkTo("command","roundcoefficients","roundcoefficients");?>, <?php linkTo("command","double","double");?>, <?php linkTo("command","doubledouble","doubledouble");?>, <?php linkTo("command","tripledouble","tripledouble");?>, <?php linkTo("command","bashevaluate","bashevaluate");?>, <?php linkTo("command","printexpansion","printexpansion");?>, <?php linkTo("command","error","error");?>, <?php linkTo("command","remez","remez");?>, <?php linkTo("command","fpminimax","fpminimax");?>, <?php linkTo("command","taylor","taylor");?>, <?php linkTo("command","implementconstant","implementconstant");?> 
</div> 
